...
const categories = [
    {
        ...
        content: {
            overview: "The agricultural sector faces the challenge of optimizing water use while maintaining sustainability to meet growing global demands. Since farming consumes 70% of the world's freshwater supply, integrating cutting-edge technologies and best practices is essential for long-term success. At TURGSOF LTD, we are dedicated to delivering solutions that help farmers maintain high standards of water quality, distribution, and management—even in the most demanding conditions.",
            approach: [
    ...
    },
    {
        ...
        content: {
            overview: "Modern buildings and facilities require reliable water management systems to ensure safety, efficiency, and sustainability. From commercial buildings to educational institutions, TURGSOF LTD provides tailored solutions that address the unique water challenges faced by facility managers and building owners.",
            approach: [
    ...
    },
    {
        ...
        content: {
            overview: "Construction projects face numerous water-related challenges, from dewatering and erosion control to water supply and wastewater management. TURGSOF LTD offers specialized solutions that help construction companies overcome these challenges while maintaining compliance with environmental regulations and project timelines.",
            approach: [
    ...
    },
    {
        ...
        content: {
            overview: "The energy and power generation sector relies heavily on water for various processes, from cooling systems to steam production. TURGSOF LTD provides specialized water treatment and management solutions that enhance efficiency, reduce environmental impact, and ensure regulatory compliance across all types of power generation facilities.",
            approach: [
                "System optimization",
                "Water conservation",
                "Process improvement",
    ...
    },
    {
        ...
        content: {
            overview: "Environmental protection is at the core of sustainable water management. TURGSOF LTD develops and implements solutions that help organizations minimize their environmental footprint, protect natural water resources, and restore ecosystems affected by human activities.",
            approach: [
    ...
    },
    {
        ...
        content: {
            overview: "The food and beverage industry requires high-quality water for product formulation, processing, and cleaning operations. TURGSOF LTD provides comprehensive water and wastewater solutions that ensure product quality, safety, and regulatory compliance while optimizing resource use and reducing operational costs.",
            approach: [
    ...
    },
    {
        ...
        content: {
            overview: "Industrial operations across various sectors face common challenges in water management, including process water treatment, wastewater handling, and regulatory compliance. TURGSOF LTD offers versatile solutions that address these challenges while improving operational efficiency and sustainability.",
            approach: [
                "Process assessment",
                "System optimization",
                "Water conservation",
    ...
    },
    {
        ...
        content: {
            overview: "Healthcare facilities require ultra-pure water for various critical applications, from laboratory testing to equipment sterilization. TURGSOF LTD provides specialized water treatment solutions that meet the stringent quality standards of the healthcare industry while ensuring patient safety and operational efficiency.",
            approach: [
                "Quality assurance",
                "Infection control",
                "System reliability",
    ...
    },
    {
        ...
        content: {
            overview: "The metals and mining industry faces unique water management challenges, from acid mine drainage to process water treatment and tailings management. TURGSOF LTD develops customized solutions that address these challenges while promoting sustainability, regulatory compliance, and operational efficiency.",
            approach: [
                "Site-specific assessment",
    ...
    },
    {
        ...
        content: {
            overview: "The microelectronics and semiconductor industry requires ultra-pure water for manufacturing processes, where even microscopic contaminants can cause product defects. TURGSOF LTD provides advanced water purification systems that meet the exacting standards of this high-tech industry while optimizing resource use and operational efficiency.",
            approach: [
    ...
    },
    {
        ...
        content: {
            overview: "Providing safe, clean drinking water is essential for public health and community well-being. TURGSOF LTD works with municipalities to design, implement, and maintain water treatment systems that ensure consistent water quality, regulatory compliance, and operational efficiency, even as communities grow and regulations evolve.",
            approach: [
    ...
    },
    {
        ...
        content: {
            overview: "The oil and gas industry faces complex water management challenges throughout the exploration, production, and refining processes. TURGSOF LTD provides specialized solutions for produced water treatment, enhanced oil recovery, and process water management that improve operational efficiency while ensuring environmental compliance.",
            approach: [
    ...
    },
    {
        ...
        content: {
            overview: "The refining and chemical industries rely on water for numerous processes, from cooling and steam generation to product formulation and equipment cleaning. TURGSOF LTD provides comprehensive water management solutions that enhance process efficiency, ensure product quality, and support environmental compliance in these demanding industrial environments.",
            approach: [
                "Process water optimization",
    ...
    },
    {
        ...
        content: {
            overview: "The transportation sector, including aviation, maritime, rail, and road transportation, faces unique water management challenges related to vehicle maintenance, facility operations, and environmental compliance. TURGSOF LTD provides specialized solutions that address these challenges while promoting operational efficiency and sustainability.",
            approach: [
                "Facility assessment",
                "System optimization",
